...
const option::Descriptor usage[] = {
        ...
        {FIRST, 0, "f", "first", Arg::Optional, " -f[<arg>], \t--first[=<arg>]" " \tType of first player. Default is Random player."},
        {SECOND, 0, "s", "second", Arg::Optional, " -s[<arg>], \t--second[=<arg>]" " \tType of second player. Default is Random player."},
